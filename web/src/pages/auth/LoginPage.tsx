      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="flex flex-col items-center mb-8">
            {systemConfig?.logo_url ? (
              <img
                ...
                alt="Logo"
                className="w-16 h-16 rounded-2xl mb-4 shadow-sm"
              />
            ) : (
              <div
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            {error && (
              <div className="mb-4 p-3 bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-800/60 rounded-lg text-sm text-red-700 dark:text-red-200">
                {error}
              </div>
            )}
